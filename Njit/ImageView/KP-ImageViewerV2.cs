...
namespace KaiwaProjects
{
    ...
    public delegate void onMouse1Click();
    public enum KpZoom
    {
        ZoomIn,
        ZoomOut
    ...
    public partial class KpImageViewer : UserControl
    {
        ...
        public event onMouse1Click Mouse1Click;
        ...
        private void UpdatePanels(bool updatePreview)
        {
            if (drawing.CurrentSize.Width > 0 && drawing.OriginalSize.Width > 0)
            {
                ...
                if (updatePreview && drawing.PreviewImage != null )
                {
                    // No memory leaks here
                    if (preview != null)
                    {
        ...
        private void pbPanel_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                drawing.JumpToOrigin(e.X, e.Y, 200, 200, pbFull.Width, pbFull.Height);
                UpdatePanels(true);
