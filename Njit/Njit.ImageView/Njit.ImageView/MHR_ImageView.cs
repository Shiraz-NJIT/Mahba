...
using Njit.ImageView.Properties;

namespace Njit.ImageView
{
    public delegate void onPrintClick();
    public delegate void onSaveClick();
    public delegate void onNextClick();
    public delegate void onPreviewClick();
    public delegate void onWarningClick();
    public enum KpZoom
    {
        ZoomIn,
        ZoomOut
    }
    public partial class MHR_ImageView : UserControl
    {
        public MHR_ImageView()
        {
        ...
        public event onPrintClick printClick;
        public event onSaveClick SaveClick;
        public event onNextClick NextClick;
        public event onPreviewClick PreviewClick;
        public event onWarningClick WarningClick;
        ...
        private void MHR_ImageView_Click(object sender, EventArgs e)
        {
            FocusOnMe();
        }
        ...
        private void btnMode_Click(object sender, EventArgs e)
        {
            ...
            {
                selectMode = true;
                this.btnMode.Image = Resources.btnDrag;
            }
            else
            {
                selectMode = false;
                this.btnMode.Image = Resources.btnSelect;
            }
        }
        ...
        {
            if (cmTitile.SelectedIndex==-1)
            {
                MessageBox.Show("عنوان خرابی را وارد کنید");
            }
            else
            {
                WarningClick();
        ...
        {
            get { return txtWarning.Text; }
            set { txtWarning.Text = value ; }
        }
        ...
        {
            get { return txtPerssonel.Text; }
            set { txtPerssonel.Text = value; }
        }
        public int cmTilte
        {
            get { return cmTitile.SelectedIndex ; }
            set { cmTitile.SelectedIndex = value; }
        }
    }
