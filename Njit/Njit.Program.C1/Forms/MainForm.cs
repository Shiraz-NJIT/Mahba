...
{
    public partial class MainForm : Njit.Program.ComponentOne.Forms.BaseForm
    {
        public MainForm()
        {
            InitializeComponent();
        ...
        protected override void OnFormClosed(FormClosedEventArgs e)
        {
            ...
            if (Options.SettingInitializer.GetProgramSetting().ShowBackupFormOnExit)
            {
                if (Options.SettingInitializer.GetProgramSetting().ShowExitDialog)
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            {
                Njit.Program.ComponentOne.Forms.SaveAccessPermissionTree f = new Njit.Program.ComponentOne.Forms.SaveAccessPermissionTree(Options.SettingInitializer.GetProgramSetting().GetExecutingAssembly(), Options.SettingInitializer.GetSqlSetting().DatabaseConnection.ConnectionString);
                f.ShowDialog();
            }
        }
