...
namespace Njit.Common.Popup
{
    ...
    public partial class Popup : ToolStripDropDown
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the <see cref="Popup.Popup"></see> acts like a transparent windows (so it cannot be clicked).
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Popup.Popup"/> class.
        /// </summary>
        ...
        public Popup(Control content, bool FocusOnOpen, bool AcceptAlt, bool TabStop, bool AutoClose, Njit.Common.Popup.PopupAnimations showingAnimation, int showingDuration, Njit.Common.Popup.PopupAnimations hidingAnimation, int hidingDuration)
        {
            if (content == null)
            {
            ...
            this.Padding = Margin = _host.Padding = _host.Margin = Padding.Empty;
            ...
            this.TabStop = content.TabStop = TabStop;
        ...
        public Popup(Control content)
            : this(content, true, true, true, true, PopupAnimations.SystemDefault, 100, PopupAnimations.None, 100)
        {
        ...
        protected override void OnVisibleChanged(EventArgs e)
        {
            ...
            int AnimationDuration = Visible ? ShowingDuration : HidingDuration;
        ...
        private bool OnNcHitTest(ref Message m, bool contentControl)
        {
            ...
            Njit.Common.Popup.GripBounds gripBouns = new Njit.Common.Popup.GripBounds(contentControl ? Content.ClientRectangle : ClientRectangle);
