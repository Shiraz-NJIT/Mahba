...
Friend Class ChevronButton
    ...
    Protected Overrides Sub OnKeyDown(ByVal kevent As Global.System.Windows.Forms.KeyEventArgs)
    ...
    Protected Overrides Sub OnKeyUp(ByVal kevent As Global.System.Windows.Forms.KeyEventArgs)
    ...
    Protected Overrides Sub OnMouseDown(ByVal mevent As Global.System.Windows.Forms.MouseEventArgs)
    ...
    Protected Overrides Sub OnMouseUp(ByVal mevent As Global.System.Windows.Forms.MouseEventArgs)
        If (isMouseDown) Then
            isMouseDown = False
            SetImage()
        End If
    ...
    Protected Overrides Sub OnMouseMove(ByVal mevent As Global.System.Windows.Forms.MouseEventArgs)
