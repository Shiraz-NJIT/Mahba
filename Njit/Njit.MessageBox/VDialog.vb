...
#Region " Methods "
    ...
    Private Sub vdf_LinkClicked(ByVal sender As Object, ByVal e As LinkLabelLinkClickedEventArgs)
...
#Region " Fields and Properties "
    ...
    Private _rightToLeft As RightToLeft = Windows.Forms.RightToLeft.Yes
    ''' <summary>
    ...
    Private _expanded As Windows.Forms.LinkLabel
    ''' <summary>
    ''' The collection of links contained within the Footer LinkLabel.
    ''' </summary>
    Public ReadOnly Property ExpandedInformationLinks() As Windows.Forms.LinkLabel.LinkCollection
        Get
