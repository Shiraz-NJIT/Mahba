...
Friend Class VDialogForm
    ...
    Public Sub New()
        ...
        Font = New Font("Tahoma", 9.0F, Global.System.Drawing.FontStyle.Regular, Global.System.Drawing.GraphicsUnit.Point, 178) ' SystemFonts.MessageBoxFont
    ...
    Protected Overrides ReadOnly Property CreateParams() As Global.System.Windows.Forms.CreateParams
        Get
...
#Region " Fields and Properties "
    ...
    Public Property MainIcon() As VDialogIcon
        ...
        Set(ByVal value As VDialogIcon)
            ...
            _drawGradient = False
            Sound = Nothing 'VDialogSound.Default
...
#End Region
    ...
    Private Sub VDialogForm_FormClosing(ByVal sender As Object, ByVal e As Global.System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        'Visible = False
    ...
    Private Sub VDialog_FormClosed(ByVal sender As Object, ByVal e As Global.System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
    ...
    Private Sub Button_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click, Button2.Click, Button3.Click, Button4.Click, Button5.Click, Button6.Click, Button7.Click, Button8.Click, Button9.Click, Button10.Click, Button11.Click
    ...
    Private Sub TableLayoutPanelContent_CellPaint(ByVal sender As Object, ByVal e As Global.System.Windows.Forms.TableLayoutCellPaintEventArgs) Handles TableLayoutPanelContent.CellPaint
        If _drawGradient AndAlso e.Row = 0 AndAlso e.Column = 1 Then
            ...
            Using b As New Global.System.Drawing.Drawing2D.LinearGradientBrush(bounds, _gradientBegin, _gradientEnd, Drawing2D.LinearGradientMode.Horizontal)
                e.Graphics.FillRectangle(b, bounds)
            End Using
        End If
    End Sub

    Private Sub LabelIcon_Paint(ByVal sender As Object, ByVal e As Global.System.Windows.Forms.PaintEventArgs) Handles LabelIcon.Paint
    ...
    Private Sub ButtonExpander_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ButtonExpander.Click
        Expanded = Expanded Xor True
        MakeCenter()
    End Sub

    Private Sub RaiseLinkClicked(ByVal sender As Object, ByVal e As Global.System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles LabelFooter.LinkClicked, LabelExpandedFooter.LinkClicked, LabelExpandedContent.LinkClicked, LabelContent.LinkClicked
