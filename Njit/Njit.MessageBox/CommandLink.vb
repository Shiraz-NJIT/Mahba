...
#Region " Painting "
    ...
    Private Sub DrawAlphaImage(ByVal alphaImage As Image, ByVal image As Image, ByVal percent As Single)
        ...
        Dim matrix As New Global.System.Drawing.Imaging.ColorMatrix(newColorMatrix)
        Dim imageAttributes As New Global.System.Drawing.Imaging.ImageAttributes()
    ...
    Private Sub DrawButtonBackground(ByVal g As Graphics, ByVal rectangle As Rectangle, ByVal frameType As FrameType)
        ...
        Select Case frameType
            Case CommandLink.FrameType.Disabled
                ' TODO: gray elevated
                If _showElevationIcon Then g.DrawImage(My.Resources.SmallSecurity, 10, 14) Else g.DrawImage(If(Me.RightToLeft = Windows.Forms.RightToLeft.Yes, My.Resources.ArrowDisabledRtl, My.Resources.ArrowDisabled), If(Me.RightToLeft = Windows.Forms.RightToLeft.Yes, Me.Width - 20 - 8, 8), 12)
            ...
            Case CommandLink.FrameType.Pressed
                ...
                Using bw As GraphicsPath = CreateRoundRectangle(rect, 3)
                    ...
                    End Using
                End Using
                If _showElevationIcon Then g.DrawImage(My.Resources.SmallSecurity, 10, 14) Else g.DrawImage(If(Me.RightToLeft = Windows.Forms.RightToLeft.Yes, My.Resources.ArrowNormalRtl, My.Resources.ArrowNormal), If(Me.RightToLeft = Windows.Forms.RightToLeft.Yes, Me.Width - 20 - 8, 8), 12)
            ...
            Case CommandLink.FrameType.Hovered
                ...
                Using bw As GraphicsPath = CreateRoundRectangle(rect, 2)
                    ...
                    End If
                End Using
                Dim arrowHovered As Bitmap
                If (Me.RightToLeft = Windows.Forms.RightToLeft.Yes) Then
                    arrowHovered = My.Resources.ArrowHoveredRtl
                Else
                    arrowHovered = My.Resources.ArrowHovered
                End If
                If _showElevationIcon Then g.DrawImage(My.Resources.SmallSecurity, 10, 14) Else g.DrawImage(arrowHovered, If(Me.RightToLeft = Windows.Forms.RightToLeft.Yes, Me.Width - 20 - 8, 8), 12)
            ...
            Case CommandLink.FrameType.Active1
                ...
                Using bw As GraphicsPath = CreateRoundRectangle(rect, 3)
                    ...
                    End Using
                End Using
                Dim arrowNormal As Bitmap
                If (Me.RightToLeft = Windows.Forms.RightToLeft.Yes) Then
                    arrowNormal = My.Resources.ArrowNormalRtl
                Else
                    arrowNormal = My.Resources.ArrowNormal
                End If
                If _showElevationIcon Then g.DrawImage(My.Resources.SmallSecurity, 10, 14) Else g.DrawImage(arrowNormal, If(Me.RightToLeft = Windows.Forms.RightToLeft.Yes, Me.Width - 20 - 8, 8), 12)
            ...
            Case CommandLink.FrameType.Active2
                ...
                Using bw As GraphicsPath = CreateRoundRectangle(rect, 3)
                    ...
                    End Using
                End Using
                Dim arrowNormal2 As Bitmap
                If (Me.RightToLeft = Windows.Forms.RightToLeft.Yes) Then
                    arrowNormal2 = My.Resources.ArrowNormalRtl
                Else
                    arrowNormal2 = My.Resources.ArrowNormal
                End If
                If _showElevationIcon Then g.DrawImage(My.Resources.SmallSecurity, 10, 14) Else g.DrawImage(arrowNormal2, If(Me.RightToLeft = Windows.Forms.RightToLeft.Yes, Me.Width - 20 - 8, 8), 12)
    ...
    '            Dim matrix As New Global.System.Drawing.Imaging.ColorMatrix(newColorMatrix)
    '            Dim disabledImageAttr As New Global.System.Drawing.Imaging.ImageAttributes()
