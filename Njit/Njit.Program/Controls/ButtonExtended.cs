...
namespace Njit.Program.Controls
{
    ...
    public partial class ButtonExtended : System.Windows.Forms.Button, Njit.Common.IAccessPermission
    {
        ...
        protected override void OnClick(EventArgs e)
        {
            ...
            if (this.ContextMenuStrip != null && this.ContextMenuStrip.Enabled)
                this.ContextMenuStrip.Show(this, this.Width, this.Height);
        }
