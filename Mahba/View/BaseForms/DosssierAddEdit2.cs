...
{
    public partial class DosssierAddEdit2 : Njit.Program.Forms.BaseFormSizable
    {
        public DosssierAddEdit2()
        {
            InitializeComponent();
        ...
        private AutoCompleteTextbox2 _PersonnelNumberTextBox;
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        protected AutoCompleteTextbox2 PersonnelNumberTextBox
        {
            get
            {
                if (_PersonnelNumberTextBox == null)
                {
                    _PersonnelNumberTextBox = DossierFormHelper.CreateAutoTextBox2(Setting.Archive.ThisProgram.LoadedArchiveSettings.PersonnelNumber_Label, "PersonnelNumber", (int)Enums.FieldTypes.متن, Setting.Archive.ThisProgram.LoadedArchiveSettings.PersonnelNumber_MinLength, Setting.Archive.ThisProgram.LoadedArchiveSettings.PersonnelNumber_MaxLength, null, null, null, 0, 0, System.Windows.Forms.RightToLeft.No);
