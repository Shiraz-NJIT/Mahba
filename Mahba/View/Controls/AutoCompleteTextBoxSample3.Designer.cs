namespace AutoCompleteTextBoxSample3
{
    using System;
    ...
    public class AutoCompleteTextbox3 : TextBox
    {
        #region Fields
            ...
            : base()
        {
            ...
            //this.listBox.Enter += new KeyEventHandler(listBox_KeyDown);
