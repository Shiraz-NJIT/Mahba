...
{
    public partial class SetPermissionTitle : Njit.Program.Forms.OKCancelForm
    {
        public SetPermissionTitle()
        {
            InitializeComponent();
        }
        ...
        private void SetPermissionTitle_Load(object sender, EventArgs e)
        {
            ...
            if (query.Any())
            {
                ...
                System.Data.DataTable tempDataTable = SqlHelper.GetField("Field12");
                ...
                {
                    MessageBox.Show("هیچ عنوانی برای اسناد در نظر گرفته نشده است");
                }
            }
        }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            //ابتدا تمامی سطوح دسترسی قبلی کاربر را پاک  تمامی کنیم
             foreach (var item in dc.PermissionTitles.Where(q => q.PK_User == Convert.ToInt32(cmUsers.SelectedValue) && q.PK_Archive==Setting.Archive.ThisProgram.SelectedArchiveTree.ArchiveID))
            {
            ...
            {
                Model.Common.PermissionTitle df = new Model.Common.PermissionTitle();
                ...
                df.PK_TitleORField11 = Convert.ToInt32(checkedItem[cblTitle.ValueMember].ToString());
            ...
            Setting.User.ThisProgram.AddLog(dc, Setting.User.UserOparatesPlaceNames.سطح_دسترسی, Setting.User.UserOparatesNames.ویرایش, null, "تنطیم سطح دسترسی عناوین اسناد مربوط به کاربر: " + member.FullName + " توسط : " + Setting.User.ThisProgram.GetCurrentUser<Model.Common.User>().FullName + "'");
            MessageBox.Show("سطوح دسترسی " +"'"+member.FullName+"'ویرایش شد.");
        }
        ...
        private void ChangePermission(int _userid)
        {
            ...
            foreach (var item in dc.PermissionTitles.Where(q => q.PK_User == _userid && q.PK_Archive==Setting.Archive.ThisProgram.SelectedArchiveTree.ArchiveID))
            {
                cblTitle.SetItemChecked(GetItemIndexWithValue(item.PK_TitleORField11), true);
            }
        }
