...
{
    public partial class SetPermissionSecurity : Njit.Program.Forms.OKCancelForm
    {
        public SetPermissionSecurity()
        {
            InitializeComponent();
        }
        ...
        private void SetPermissionSecurity_Load(object sender, EventArgs e)
        {
            ...
            if (query.Any())
            {
                ...
                System.Data.DataTable tempDataTable = SqlHelper.GetField("Field18");
                ...
                {
                    MessageBox.Show(" نوع دسترسی برای اسناد در نظر گرفته نشده است");
                }
            }
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            foreach (var item in dc.PermissionSecurities.Where(q => q.PK_User == Convert.ToInt32(cmUsers.SelectedValue) && q.PK_Archive == Setting.Archive.ThisProgram.SelectedArchiveTree.ArchiveID))
            {
            ...
            {
                Model.Common.PermissionSecurity df = new Model.Common.PermissionSecurity();
                ...
                df.PK_SecurityORField18 = Convert.ToInt32(checkedItem[cblTitle.ValueMember].ToString());
            ...
            Setting.User.ThisProgram.AddLog(dc, Setting.User.UserOparatesPlaceNames.سطح_دسترسی, Setting.User.UserOparatesNames.ویرایش, null, "تنطیم سطح دسترسی کاربر: " + member.FullName + " توسط : " + Setting.User.ThisProgram.GetCurrentUser<Model.Common.User>().FullName + "'");
        ...
        private void ChangePermission(int _userid)
        {
            ...
            foreach (var item in dc.PermissionSecurities.Where(q => q.PK_User == _userid && q.PK_Archive == Setting.Archive.ThisProgram.SelectedArchiveTree.ArchiveID))
            {
                cblTitle.SetItemChecked(GetItemIndexWithValue(item.PK_SecurityORField18), true);
            }
        }
